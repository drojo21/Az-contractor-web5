...
export default function TestimonialsManagement() {
  ...
  const saveTestimonial = async () => {
    try {
      ...
      setSaveError('Failed to save testimonial. Please try again.');
    }
  };
          ...
          >
            ...
            {deleteConfirmId === testimonial.id ? (
              <div className="flex items-center gap-2 bg-red-50 border border-red-200 rounded-lg p-3">
                <span className="text-sm text-red-700 flex-1">Delete this testimonial?</span>
                <button
                ...
                <button
                  ...
                  className="px-3 py-1.5 bg-slate-200 hover:bg-slate-300 text-slate-700 rounded text-sm font-medium transition-colors"
                >
                  Cancel
                </button>
              </div>
